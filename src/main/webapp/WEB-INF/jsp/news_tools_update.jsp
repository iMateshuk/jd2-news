		...
		<div class="locale">
			...
			<div class="en">
				...
				<form action="Controller" method="post">
					...
					<button class="local" type="submit" name="command" value="news_tools_update"/>${ru_button}</button>
				</form>
			</div>
			...
			<div class="ru">
				...
				<form action="Controller" method="post">
					...
					<button class="local" type="submit" name="command" value="news_tools_update" />${en_button}</button>
				</form>
			</div>
		</div>
		<br /> <br />
