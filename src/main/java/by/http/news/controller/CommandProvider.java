...
import by.http.news.controller.impl.GoToUserForcePage;
...
import by.http.news.controller.impl.GoToNewsForcePage;
...
public class CommandProvider {
	...
	public CommandProvider() {
		...
		commands.put(CommandName.USER_FORCE, new GoToUserForcePage());
		...
		commands.put(CommandName.NEWS_FORCE, new GoToNewsForcePage());
